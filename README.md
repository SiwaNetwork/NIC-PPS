...
- ✅ **Исправлено определение PTP устройства для Intel I210** - PPS сигнал теперь корректно выдается на разъем INTEL I210
- ✅ **Система версионирования** - отображение версии в GUI, веб-интерфейсе и API
- ✅ **Улучшенная стабильность** - исправлены проблемы с кнопками включения/выключения PPS
